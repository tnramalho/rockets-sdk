...
const rockets_server_utils_1 = require("../rockets-server.utils");
exports.authenticationOptionsDefaultConfig = (0, config_1.registerAs)(rockets_server_constants_1.ROCKETS_SERVER_MODULE_OPTIONS_DEFAULT_SETTINGS_TOKEN, () => {
    ...
    return {
        email: {
            from: 'from',
            baseUrl: 'baseUrl',
            tokenUrlFormatter: rockets_server_utils_1.formatTokenUrl,
            templates: {
                sendOtp: {
...
//# sourceMappingURL=rockets-server-options-default.config.js.map