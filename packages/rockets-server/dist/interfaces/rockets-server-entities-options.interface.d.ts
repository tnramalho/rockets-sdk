...
import { UserEntityInterface, UserProfileEntityInterface } from '@concepta/nestjs-user';
...
export interface RocketsServerEntitiesOptionsInterface extends UserEntitiesOptionsInterface {
    entities: {
...
//# sourceMappingURL=rockets-server-entities-options.interface.d.ts.map