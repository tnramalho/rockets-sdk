...
import { RocketsServerAuthNotificationServiceInterface } from './rockets-server-auth-notification.service.interface';
import { RocketsServerAuthSettingsInterface } from './rockets-server-auth-settings.interface';
import { RocketsServerAuthUserModelServiceInterface } from './rockets-server-auth-user-model-service.interface';
 ...
 */
export interface RocketsServerAuthOptionsInterface {
  /**
